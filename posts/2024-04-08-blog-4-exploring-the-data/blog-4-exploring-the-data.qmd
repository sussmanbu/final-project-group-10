...
score_regression_model <- lm(mn_score_all ~ mn_score_asn + mn_score_blk + mn_score_ecd + mn_score_fem + mn_score_hsp + mn_score_male + mn_score_mtr + mn_score_wht, data = cleaned_seda)
