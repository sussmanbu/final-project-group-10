...
score_regression_model <- lm(mn_score_all ~ lninc50all + baplusall + povertyall + numstu_ecd + numstu_male + numstu_fem + perasn + perhsp + perblk + perwht, data = cleaned_seda)
