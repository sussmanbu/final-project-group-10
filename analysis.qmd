...
summary(weighted_regression) #make this a nicer table?
...
regMA <- tidy(weighted_regression)
...
#forestplot(
 ...
 # lower = regMA$lower,
  #upper = regMA$upper,
 # labeltext = regMA$term,
 # xlab = xlab_set,
 # cex = 0.8,
#  boxsize = 0.15,
 # lwd.ci= 2,
 # lineheight = "lines",
 # col = fpColors(box = "chartreuse4", line = "black", summary = "darkgreen"),
...
forestplot(
  ...
  lower = regMS$lower,
  upper = regMS$upper,
  labeltext = regMS$term,
  xlab = "Adjusted Coefficients and 95% Confidence Intervals",
  boxsize = 0.15,
  lwd.ci= 2,
  lineheight = "lines",
  col = fpColors(box = "cornflowerblue", line = "black", summary = "steelblue"),
